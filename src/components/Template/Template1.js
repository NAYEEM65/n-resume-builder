    ...
    return (
        <div className="py-10 px-5 ">
            ...
            <div>
                ...
                <div className="mt-5">
                    <h3 className="text-xl py-2 font-bold border-b border-gray-300">Objective</h3>
                    <p className="text-sm pt-4 pb-3">{user.carrierObjective}</p>
                </div>
                <div className="w-full h-[2px] bg-gray-500 my-4" />
                <div className="mt-5">
                    <h3 className="text-xl py-2 font-bold border-b border-gray-300">Eductaion</h3>
                ...
                <div className="w-full h-[2px] bg-gray-500 my-4" />
                <div className="mt-5">
                    <h3 className="text-xl py-2 font-bold border-b border-gray-300">Experience</h3>
                ...
                <div className="w-full h-[2px] bg-gray-500 my-4" />
                <div className="mt-5">
                    <h3 className="text-xl py-2 font-bold border-b border-gray-300">Projects</h3>
                ...
                <div className="w-full h-[2px] bg-gray-500 my-4" />
                <div className="mt-5">
                    <h3 className="text-xl py-2 font-bold border-b border-gray-300">Skills</h3>
